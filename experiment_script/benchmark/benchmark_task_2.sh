...
singularity exec --nv --bind $working_dir:$singularity_working_dir $singularity_path python /home/acollin/dca_permuted_workflow/experiment_script/benchmark/02_label_transfer_pct_split.py --dataset_name $dataset_name --class_key $class_key --use_hvg 3000 --batch_key $batch_key --mode percentage --obs_key $batch_key &> /home/acollin/dca_permuted_workflow/experiment_script/benchmark/$dataset_name_2.log