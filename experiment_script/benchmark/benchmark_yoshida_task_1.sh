...
singularity exec --nv --bind $working_dir:$singularity_working_dir $singularity_path python /home/acollin/dca_permuted_workflow/experiment_script/benchmark/01_label_transfer_between_batch.py --dataset_name yoshida_2021 --class_key Original_annotation --use_hvg 10000 --batch_key batch --mode entire_condition --obs_key batch --keep_obs AN1 AN11 AN12 AN13 AN3 AN6 AN7 --test_split_key TRAIN_TEST_split_batch &> /home/acollin/dca_permuted_workflow/experiment_script/benchmark/yoshida_1.log