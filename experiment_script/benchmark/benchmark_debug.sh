...
singularity exec --nv --bind $working_dir:$singularity_working_dir $singularity_path python /home/acollin/dca_permuted_workflow/experiment_script/benchmark/01_label_transfer_between_batch.py --dataset_name yoshida_2021_debug --class_key Original_annotation --batch_key batch --mode entire_condition --obs_key batch --keep_obs AN1 AN11 AN12 AN13 AN3 AN6 AN7 --test_split_key TRAIN_TEST_split_batch &> /home/acollin/dca_permuted_workflow/experiment_script/benchmark/benchmark_debug.log
