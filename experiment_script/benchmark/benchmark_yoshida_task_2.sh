...
singularity exec --nv --bind $working_dir:$singularity_working_dir $singularity_path python /home/acollin/dca_permuted_workflow/experiment_script/benchmark/02_label_transfer_pct_split.py --dataset_name yoshida_2021 --class_key Original_annotation --use_hvg 3000 --batch_key batch --mode percentage --obs_key batch --test_split_key TRAIN_TEST_split_batch &> /home/acollin/dca_permuted_workflow/experiment_script/benchmark/yoshida_2.log