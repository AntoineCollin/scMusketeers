...
for dataset in  "tran_2021" "tabula_2022_spleen" "dominguez_2022_lymph"  #"koenig_2022" "tosti_2021"; #  "yoshida_2021" 
do
    sbatch --partition=gpu --gres=gpu:1 --time=35:00:00 --job-name hp_$dataset 01_hp_optim.sh $dataset Original_annotation batch
done

# for dataset in  "litvinukova_2020"  ; # "lake_2021" "dominguez_2022_lymph" "dominguez_2022_spleen"
# do
