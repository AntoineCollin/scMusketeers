...
try :
    ...
    from ...scmusketeers.tools.utils import get_optimizer, scanpy_to_input, default_value, str2bool
    from ...scmusketeers.tools.clust_compute import nn_overlap, batch_entropy_mixing_score
