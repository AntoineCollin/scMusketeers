...
def create_argparser():
    ...
    workflow_group.add_argument('--verbose', type = str2bool.str2bool, default = True, help ='')
    ...
    dataset_group.add_argument('--scale_input', type=str2bool.str2bool, nargs='?',const=False, default=False, help ='Weither to scale input the count values')
    dataset_group.add_argument('--logtrans_input', type=str2bool.str2bool, nargs='?',const=True, default=True, help ='Weither to log transform count values')
    ...
    training_group.add_argument('--test_obs', type = str,nargs='+', default = None, help ='batches from batch_key to use as test')
    training_group.add_argument('--test_index_name', type = str,nargs='+', default = None, help ='indexes to be used as test. Overwrites test_obs')
    training_group.add_argument('--mode', type = str, default = 'percentage', help ='Train test split mode to be used by Dataset.train_split')
    training_group.add_argument('--pct_split', type = float, nargs='?', default = 0.9, help ='')
    training_group.add_argument('--obs_key', type = str, nargs='?', default = 'manip', help ='')
    training_group.add_argument('--n_keep', type = int, nargs='?', default = None, help ='batches from obs_key to use as train')
    training_group.add_argument('--split_strategy', type = str,nargs='?', default = None, help ='')
    training_group.add_argument('--keep_obs', type = str,nargs='+',default = None, help ='')
    training_group.add_argument('--train_test_random_seed', type = float,nargs='?', default = 0, help ='')
    training_group.add_argument('--obs_subsample', type = str,nargs='?', default = None, help ='')
    training_group.add_argument('--make_fake', type=str2bool.str2bool, nargs='?',const=False, default=False, help ='')
    ...
    architecture_group.add_argument('--layer1', type=int,nargs='?', default = None, help ='size of the first layer for a 2-layers model. If specified, overwrites ae_hidden_size')
    architecture_group.add_argument('--layer2', type=int,nargs='?', default = None, help ='size of the second layer for a 2-layers model. If specified, overwrites ae_hidden_size')
    architecture_group.add_argument('--bottleneck', type=int,nargs='?', default = None, help ='size of the bottleneck layer. If specified, overwrites ae_hidden_size')
    
    # Autoencoder arguments
    ae_group = parser.add_argument_group('Autoencoder Architecture')
    ae_group.add_argument('--ae_hidden_size', type = int,nargs='+', default = [128,64,128], help ='Hidden sizes of the successive ae layers')
    ae_group.add_argument('--ae_hidden_dropout', type =float, nargs='?', default = None, help ='')
    ae_group.add_argument('--ae_activation', type = str ,nargs='?', default = 'relu' , help ='')
    ae_group.add_argument('--ae_bottleneck_activation', type = str ,nargs='?', default = 'linear' , help ='activation of the bottleneck layer')
    ae_group.add_argument('--ae_output_activation', type = str,nargs='?', default = 'relu', help ='')
    ae_group.add_argument('--ae_init', type = str,nargs='?', default = 'glorot_uniform', help ='')
    ae_group.add_argument('--ae_batchnorm', type=str2bool.str2bool, nargs='?',const=True, default=True , help ='')
    ae_group.add_argument('--ae_l1_enc_coef', type = float,nargs='?', default = None, help ='')
    ae_group.add_argument('--ae_l2_enc_coef', type = float,nargs='?', default = None, help ='')
    
    # Classification model arguments
    class_group = parser.add_argument_group('Classification Architecture')
    class_group.add_argument('--class_hidden_size', type = int,nargs='+', default = [64], help ='Hidden sizes of the successive classification layers')
    class_group.add_argument('--class_hidden_dropout', type =float, nargs='?', default = None, help ='')
    class_group.add_argument('--class_batchnorm', type=str2bool.str2bool, nargs='?',const=True, default=True , help ='')
    class_group.add_argument('--class_activation', type = str ,nargs='?', default = 'relu' , help ='')
    class_group.add_argument('--class_output_activation', type = str,nargs='?', default = 'softmax', help ='')
    
    # Dann model arguments
    dann_group = parser.add_argument_group('DANN Architecture')
    dann_group.add_argument('--dann_hidden_size', type = int,nargs='?', default = [64], help ='')
    dann_group.add_argument('--dann_hidden_dropout', type =float, nargs='?', default = None, help ='')
