...
class Dataset:
    def __init__(self, 
        ...
        self.adata_train_extended = anndata.AnnData() # Contains the train and to-be-defined val data
    ...
    def train_val_split(self):
        self.adata_train_extended = self.adata[self.adata.obs[self.class_key] != self.unlabeled_category] # Contains the train and to-be-defined val data
        ...
        split[self.adata_train_extended.obs_names] = self.adata_train_extended.obs['train_split']
