...
def train_evaluate(parameterization, train_loader, valid_loader, run_neptune, device):
    """
...
def cnn_training(run_neptune, device):
    ...
    ax_client.complete_trial(trial_index=0, raw_data=train_evaluate(baseline_parameters, train_loader, valid_loader, run_neptune, device))

    for i in range(50):
        parameters, trial_index = ax_client.get_next_trial()
        # Local evaluation here can be replaced with deployment to external system.
        ax_client.complete_trial(trial_index=trial_index, raw_data=train_evaluate(parameters, train_loader, valid_loader, run_neptune, device))
